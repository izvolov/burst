#ifndef BURST_ALGORITHM_DETAIL_CROSS_PARTIAL_SUM_HPP
#define BURST_ALGORITHM_DETAIL_CROSS_PARTIAL_SUM_HPP
...
#endif // BURST_ALGORITHM_DETAIL_CROSS_PARTIAL_SUM_HPP
