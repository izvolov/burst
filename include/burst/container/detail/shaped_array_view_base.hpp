#ifndef BURST_CONTAINER_DETAIL_SHAPED_ARRAY_VIEW_BASE_HPP
#define BURST_CONTAINER_DETAIL_SHAPED_ARRAY_VIEW_BASE_HPP
...
#endif // BURST_CONTAINER_DETAIL_SHAPED_ARRAY_VIEW_BASE_HPP
