...
BOOST_AUTO_TEST_SUITE(galloping_upper_bound)
    ...
    BOOST_AUTO_TEST_CASE(searching_existing_value_results_iterator_to_first_value_greater_than_desired)
    {
        ...
        BOOST_CHECK(search_result == range.begin() + 2);
        BOOST_CHECK_EQUAL(*search_result, "c");
    }

    BOOST_AUTO_TEST_CASE(searching_existing_value_results_iterator_past_the_end_of_range_of_equal_values)
    {
