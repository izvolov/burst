...
TEST_SUITE("galloping_lower_bound")
{
    ...
    TEST_CASE("searching_existing_value_results_iterator_to_that_value")
    {
    ...
    TEST_CASE("searching_existing_value_results_iterator_to_beginning_of_range_of_equal_values")
    {
